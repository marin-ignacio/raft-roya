...
srun python3 evaluate.py --model=models/raft-things.pth --dataset=sintel --mixed_precision
srun python3 demo.py --model=models/raft-kitti.pth --path=demo-frames

python -u train.py --name raft-1 --stage sintel --validation sintel --restore_ckpt models/raft-chairs.pth --gpus 0 --num_steps 120000 --batch_size 5 --lr 0.0001 --image_size 368 768 --wdecay 0.00001 --gamma=0.85 --mixed_precision

python 

srun python3 -u train.py --name raft-1 --stage roya --validation sintel --restore_ckpt models/raft-chairs.pth --gpus 0 --num_steps 120000 --batch_size 5 --lr 0.0001 --image_size 400 720 --wdecay 0.00001 --gamma=0.85 --mixed_precision
